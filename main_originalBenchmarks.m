...
parfor idxTask = 1:9 % parallel execution
    tasks = benchmarkOriginal(idxTask); initPop=cell(2,nRepeat);
...
save('resultsOriginal9.mat','data1', 'data2', 'data3','data4', 'data5', 'data6','data7','data8','data9','nGen','nRepeat');
plotAllResults;
...
load resultsOriginal9; close all;
for idxTask = 1:9
...
outX=s:s:nGen;
for idx = 1:9
    [tasks,g1,g2] = benchmarkOriginal(idx);
    ...
    BFEV2=[data1(idx).bestFitness(nRepeat+1:end,:); data2(idx).bestFitness(2:2:end,:); ...
        ...
        squeeze(data9(idx).bestFitness(:,:,2))] ...
